...
$featurearray = array("School" => array("MIT","University of Virginia","University of North Carolina at Chapel Hill","Harvard","Stanford","University of Chicago","Berkely"),"Price" => array("$1,000","$2,000","$3,000","$4,000","$5,000"),"Perks" => array("Access to University Alumni","Continuing Education Credit","In-person Networking Oppertunities within Peers"),"Program Format" => array("Online Only - Self Paced","In-person - Traditional Classroom Environment","Weekly Classes Online Only with Peers and Professor","Majority of Classes Online with Capstone In-Person Event"),"Program Topics" => array("Corperate Responsability","Most Powerful Women","Leading in the Middle","Change Management","Cutting Edge Data Analysis Techniques"));
